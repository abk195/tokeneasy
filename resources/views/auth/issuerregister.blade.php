    ...
    <div class="form-holder">
        <div class="form-content">
            ...
            <div class="form-items">
                ...
                <p>Please enter following details to register as Issuer in the platform. A verification email will be send to your email address.</p>
                <div class="page-links">
                    <a href="#" class="active">Issuer Register</a>
                </div>

                <form method="POST" action="{{ route('Issuerregister') }}" enctype="multipart/form-data" id="form_submit">
                    @csrf
                    <div class="mb-6">
                    ...
                    <span id="email_error" style="display:none;color:red;margin-top:0;margin-bottom:1rem;">Enter a valid
                        E-mail</span>
                    </div>
                    <div class="mb-6">
                    <input class="form-control passwordField" type="password" name="password" id="password"
                    ...
                    <div class="mb-6">
                    <label for="" class="col-form-label">Issuer Identification Document (Max- 5MB)</label>
                            ...
                            <div class="register-content">
                                <div class="checkbox">
                                    <div class="form-check custom-control custom-checkbox">
                                        ...
                                        <span class="errors" id="list1_error" style="display:none;color:red;margin-top:0;margin-bottom:1rem;">Please select terms and conditions</span>
                                    </div>
                                    <div class="form-check custom-control custom-checkbox">
                                        ...
                                        <span class="errors" id="list2_error" style="display:none;color:red;margin-top:0;margin-bottom:1rem;">Please select terms and conditions</span>
                                    </div>
                                    <div class="form-check custom-control custom-checkbox">
                                        ...
                                        <span class="errors" id="list3_error" style="display:none;color:red;margin-top:0;margin-bottom:1rem;">Please select terms and conditions</span>
                                    </div>
                                    <div class="form-check custom-control custom-checkbox">
                                        ...
                                        <label class="form-check-label custom-control-label" for="list-4">You may be required to pay
                                            ...
                                            EVM Network.</label>
                                        <span class="errors" id="list4_error" style="display:none;color:red;margin-top:0;margin-bottom:1rem;">Please select terms and conditions</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <?php /*
                                                                                                                                                            <select class="browser-default custom-select form-style" name="user_type" required="">
                    ...
                    <div class="form-button mb-3">
                        <button id="submit" type="submit" id="regCheckBtn" class="ibtn btn btn-primary registerButton">Register</button>
                    </div>
