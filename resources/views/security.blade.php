    ...
    <div class="page-content">
        ...
        <div class="header-breadcrumbs">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6"><h1>Security</h1></div>
                    <div class="col-sm-6">
        ...
        <div class="content">
            ...
            <div class="container-fluid " style="border: 1px solid #e0e0e0;margin : 10px ">
                <section class="container spaceall wallet-full">
                    <div class="container">
                        <div class="tab-pane " id="profile-b2" style="padding :10px; ">
                                ...
                                <div class="col-sm-6">
                                    <form method="POST" action="{{ route('change.password') }}" id="password-update-form">
                                        ...
                                        <div class="form-group">
                                            <label for="current_password"><h4><b>Change Password</b></h4></label>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="tab-pane active" id="btc_deposit">
                                            ...
                                            <section class="withdraw-instruction">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-11">
                                                        <p> To enable 2FA, you'll need to have a 2FA auth app installed on your
                                                            phone or tablet(examples include Google Authenticator, Duo Mobile, and
                                                            Authy). </p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-11">
                                                        ...
                                                        <!-- QR Code Block -->
                                                        <div id="qrcode-BTC" class="qrcode-container img-thumbnail" data-width="180"
                                                            data-height="180" data-text="{{ @$image }}"
                                                            title="{{ @$image }}">
                                                            {!! $image !!}
                                                        </div>
                                                        <!-- End QR Code Block -->

                                                        <p class="clearfix">Generate a code from your newly-activated 2FA app to
                                                            confirm that you're all set up.</p>
                                                        ...
                                                        <div class="input-group col-sm-12 cpyInput">
                                                            ...
                                                            <div class="input-group-addon cursor" id="deposit_address_data"
                                                                title="Click to Copy"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-11">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="sendamt"
                                                                placeholder="Enter the generated 2FA passcode" maxlength="6"
                                    ...
                                    @else
                                        <div class="tab-pane active" id="btc_deposit">
                                            ...
                                            <section class="withdraw-instruction">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-11">
                                                        <form method=get action="{{ url('/2fa/disable') }}"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-sm-12 ">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="Enter 6 digits 2FA Code" name="otp"
                                                                            maxlength="6"
                                                                            onkeypress="if ( isNaN(this.value + String.fromCharCode(event.keyCode) )) return false;">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-12 col-sm-12 ">
                                                                    <div style="text-align: center;">
                                                                        <button type="submit" class="btn btn-secondary"
                                                                            style="margin-left: -524px;">Disable 2FA</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
