...
@section('content')
        ...
        <div class="header-breadcrumbs">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-6"><h1>Trades</h1></div>
                    <div class="col-sm-6">
                                ...
                                <div role="tabpanel" class="tab-pane active show" id="my_earnings">
                                    ...
                                    <section class="container table-property">
                                        ...
                                        <table class="datatable-full table table-striped table-bordered custom-table-style"
                                            ...
                                            <tbody>
                                            @foreach($trade_lists as $index => $value)
                                            <tr>
                                                <td>{{$index+1}}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary BuyTrade" href="{{ url('/finish_trade', $value->id) }}">Buy</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                            </tbody>
...
<script>
    document.querySelectorAll('.BuyTrade').forEach(function(button) {
        button.addEventListener('click', function (e) {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "Do you want to buy this trade?",
                icon: 'warning',
