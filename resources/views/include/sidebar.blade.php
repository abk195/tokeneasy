...
<aside id="layout-menu" class="layout-menu menu-vertical menu">
  ...
  <ul class="menu-inner py-1">
      ...
      <li class="menu-item {{ Request::is('propertyList') ? 'active' : '' }}">
      ...
      <li class="menu-item {{ Request::is('wallet') ? 'active' : '' }}">
          <a href="{{ $isDemo ? 'javascript:void(0);' : 'javascript:void(0);' }}" class="menu-link menu-toggle {{ $isDemo ? 'menu-disabled' : '' }}">
              <i class="menu-icon icon-base bx bx-wallet"></i>
              <div data-i18n="Wallet">Wallet</div>
          </a>
          <ul class="menu-sub">
              <li class="menu-item {{ Request::is('wallet') ? 'active' : '' }}">
                  <a href="{{ $isDemo ? 'javascript:void(0);' : route('wallet') }}" class="menu-link {{ $isDemo ? 'menu-disabled' : '' }}">
                      <div data-i18n="Deposit">Deposit</div>
                  </a>
              </li>
              <li class="menu-item {{ Request::is('withdrawETH') ? 'active' : '' }}">
                  <a href="{{ $isDemo ? 'javascript:void(0);' : url('withdrawETH') }}" class="menu-link {{ $isDemo ? 'menu-disabled' : '' }}">
      ...
      <li class="menu-item {{ Request::is('profile') ? 'active' : '' }}">
          <a href="{{ $isDemo ? 'javascript:void(0);' : url('profile') }}" class="menu-link {{ $isDemo ? 'menu-disabled' : '' }}">
              <i class="menu-icon icon-base bx bx-user"></i>
              <div data-i18n="Profile">Profile</div>
          </a>
      </li>
      <li class="menu-item {{ Request::is('investment') || Request::is('buy_requests') ? 'active open' : '' }}">
          ...
          <ul class="menu-sub">
              <li class="menu-item {{ Request::is('investment') ? 'active' : '' }}">
                  <a href="{{ url('investment') }}" class="menu-link">
                      <div data-i18n="Investments">Investments</div>
                  </a>
              </li>
              <li class="menu-item {{ Request::is('buy_requests') ? 'active' : '' }}">
                  <a href="{{ url('buy_requests') }}" class="menu-link">
                      <div data-i18n="Token Buy History">Token Buy History</div>
                  </a>
              </li>
          </ul>
      </li>
      <li class="menu-item {{ Request::is('security') ? 'active' : '' }}">
          <a href="{{ $isDemo ? 'javascript:void(0);' : route('security') }}" class="menu-link {{ $isDemo ? 'menu-disabled' : '' }}">
              <i class="menu-icon icon-base bx bx-shield-quarter"></i>
              <div data-i18n="Security">Security</div>
          </a>
      </li>
      @if($pageVisibility->get('plaid')['value'])
      <li class="menu-item {{ Request::is('plaid.index') ? 'active' : '' }}">
          <a href="{{ $isDemo ? 'javascript:void(0);' : route('plaid.index') }}" class="menu-link {{ $isDemo ? 'menu-disabled' : '' }}">
